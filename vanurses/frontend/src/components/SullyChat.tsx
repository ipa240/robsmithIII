...
import { Send, X, Loader2, Database, Globe, Zap } from 'lucide-react'
...
const MOODS: { id: Mood; label: string; color: string; desc: string; image: string }[] = [
  { id: 'optimistic', label: 'Friendly', color: 'bg-emerald-500', desc: 'Warm & encouraging', image: '/media/sully/sully-optimistic.jpg' },
  { id: 'neutral', label: 'Neutral', color: 'bg-sky-500', desc: 'Professional & balanced', image: '/media/sully/sully-neutral.jpg' },
  { id: 'stern', label: 'Stern', color: 'bg-amber-500', desc: 'Blunt & direct', image: '/media/sully/sully-stern.jpg' },
  { id: 'nofilter', label: 'No Filter', color: 'bg-red-500', desc: 'Vulgar & brutally honest', image: '/media/sully/sully-nofilter.jpg' },
]
